...
public class AxisAlignedBB
{
     ...
     */
    public double calculateXOffset(AxisAlignedBB paramAxisAlignedBB, double paramDouble) {
        ...
        if (paramAxisAlignedBB.maxZ <= this.minZ || paramAxisAlignedBB.minZ >= this.maxZ)
            return paramDouble;
        if (paramDouble > 0.0D && paramAxisAlignedBB.maxX <= this.minX) {
            double d = this.minX - paramAxisAlignedBB.maxX;
            if (d < paramDouble)
                paramDouble = d;
        }
        if (paramDouble < 0.0D && paramAxisAlignedBB.minX >= this.maxX) {
            double d = this.maxX - paramAxisAlignedBB.minX;
            if (d > paramDouble)
                paramDouble = d;
        }
        return paramDouble;
     ...
     * calculated offset.  Otherwise return the calculated offset.
     */
    public double calculateYOffset(AxisAlignedBB paramAxisAlignedBB, double paramDouble) {
        if (paramAxisAlignedBB.maxX <= this.minX || paramAxisAlignedBB.minX >= this.maxX)
            return paramDouble;
        if (paramAxisAlignedBB.maxZ <= this.minZ || paramAxisAlignedBB.minZ >= this.maxZ)
            return paramDouble;
        if (paramDouble > 0.0D && paramAxisAlignedBB.maxY <= this.minY) {
            double d = this.minY - paramAxisAlignedBB.maxY;
            if (d < paramDouble)
                paramDouble = d;
        }
        if (paramDouble < 0.0D && paramAxisAlignedBB.minY >= this.maxY) {
            double d = this.maxY - paramAxisAlignedBB.minY;
            if (d > paramDouble)
                paramDouble = d;
        }
        return paramDouble;
     ...
     * calculated offset.  Otherwise return the calculated offset.
     */
    public double calculateZOffset(AxisAlignedBB paramAxisAlignedBB, double paramDouble) {
        if (paramAxisAlignedBB.maxX <= this.minX || paramAxisAlignedBB.minX >= this.maxX)
            return paramDouble;
        if (paramAxisAlignedBB.maxY <= this.minY || paramAxisAlignedBB.minY >= this.maxY)
            return paramDouble;
        if (paramDouble > 0.0D && paramAxisAlignedBB.maxZ <= this.minZ) {
            double d = this.minZ - paramAxisAlignedBB.maxZ;
            if (d < paramDouble)
                paramDouble = d;
        }
        if (paramDouble < 0.0D && paramAxisAlignedBB.minZ >= this.maxZ) {
            double d = this.maxZ - paramAxisAlignedBB.minZ;
            if (d > paramDouble)
                paramDouble = d;
        }
        return paramDouble;

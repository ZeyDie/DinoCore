...
public class CrashReportCategory
{
    ...
    public boolean func_85069_a(final StackTraceElement par1StackTraceElement, final StackTraceElement par2StackTraceElement)
    {
        ...
        {
            final StackTraceElement stacktraceelement2 = this.stackTrace[0];
    ...
    {
        final StackTraceElement[] astacktraceelement = new StackTraceElement[this.stackTrace.length - par1];
    ...
    public void func_85072_a(final StringBuilder par1StringBuilder)
    {
        ...
        final Iterator iterator = this.field_85077_c.iterator();

        while (iterator.hasNext())
        {
            final CrashReportCategoryEntry crashreportcategoryentry = (CrashReportCategoryEntry)iterator.next();
        ...
        {
            par1StringBuilder.append("\nStacktrace:");
            final StackTraceElement[] astacktraceelement = this.stackTrace;
    ...
    public static void addBlockCrashInfo(final CrashReportCategory par0CrashReportCategory, final int par1, final int par2, final int par3, final int par4, final int par5)
    {

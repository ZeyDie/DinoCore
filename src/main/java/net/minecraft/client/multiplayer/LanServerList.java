...
public class LanServerList
{
    ...
    {
        final String s1 = ThreadLanServerPing.getMotdFromPingResponse(par1Str);
        ...
        if (s2 != null)
        {
            ...
            boolean flag = false;
            final Iterator iterator = this.listOfLanServers.iterator();

            while (iterator.hasNext())
            {
                final LanServer lanserver = (LanServer)iterator.next();

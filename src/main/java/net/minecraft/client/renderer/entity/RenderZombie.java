...
public class RenderZombie extends RenderBiped
{
    ...
    protected ResourceLocation func_110863_a(final EntityZombie par1EntityZombie)
    {
    ...
    protected void func_82430_a(final EntityZombie par1EntityZombie, final float par2, float par3, final float par4)
    {
        ...
        {
            par31 += (float)(Math.cos((double)par1EntityZombie.ticksExisted * 3.25D) * Math.PI * 0.25D);
        }

        super.rotateCorpse(par1EntityZombie, par2, par31, par4);
    }

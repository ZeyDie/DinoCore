...
public class RenderArrow extends Render
{
    ...
    public void renderArrow(final EntityArrow par1EntityArrow, final double par2, final double par4, final double par6, final float par8, final float par9)
    {
        ...
        final float f2 = 0.0F;
        final float f3 = 0.5F;
        final float f4 = (float)(0 + b0 * 10) / 32.0F;
        final float f5 = (float)(5 + b0 * 10) / 32.0F;
        final float f6 = 0.0F;
        final float f7 = 0.15625F;
        final float f8 = (float)(5 + b0 * 10) / 32.0F;
        final float f9 = (float)(10 + b0 * 10) / 32.0F;
        final float f10 = 0.05625F;
        GL11.glEnable(GL12.GL_RESCALE_NORMAL);
        final float f11 = (float)par1EntityArrow.arrowShake - par9;

...
class GuiScreenMcoWorldTemplateDownloadThread extends Thread
{
    ...
    GuiScreenMcoWorldTemplateDownloadThread(final GuiScreenMcoWorldTemplate par1GuiScreenMcoWorldTemplate)
    {
    ...
    public void run()
    {
        final McoClient mcoclient = new McoClient(GuiScreenMcoWorldTemplate.func_110382_a(this.field_111256_a).getSession());

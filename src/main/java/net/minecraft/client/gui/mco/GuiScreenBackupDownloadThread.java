...
class GuiScreenBackupDownloadThread extends Thread
{
    ...
    GuiScreenBackupDownloadThread(final GuiScreenBackup par1GuiScreenBackup)
    {
    ...
    public void run()
    {
        final McoClient mcoclient = new McoClient(GuiScreenBackup.func_110366_a(this.field_111250_a).getSession());

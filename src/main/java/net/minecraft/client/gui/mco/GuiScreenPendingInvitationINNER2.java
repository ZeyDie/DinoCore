...
class GuiScreenPendingInvitationINNER2 extends Thread
{
    ...
    GuiScreenPendingInvitationINNER2(final GuiScreenPendingInvitation par1GuiScreenPendingInvitation)
    {
    ...
    public void run()
    {
        try
        {
            final McoClient mcoclient = new McoClient(GuiScreenPendingInvitation.func_130041_c(this.field_130132_a).getSession());

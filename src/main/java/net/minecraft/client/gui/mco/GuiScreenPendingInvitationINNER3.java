...
class GuiScreenPendingInvitationINNER3 extends Thread
{
    ...
    GuiScreenPendingInvitationINNER3(final GuiScreenPendingInvitation par1GuiScreenPendingInvitation)
    {
    ...
    public void run()
    {
        try
        {
            final McoClient mcoclient = new McoClient(GuiScreenPendingInvitation.func_130046_h(this.field_130131_a).getSession());

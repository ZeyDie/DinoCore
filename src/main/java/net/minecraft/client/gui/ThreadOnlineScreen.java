...
class ThreadOnlineScreen extends Thread
{
    ...
    public void run()
    {
        try
        {
            final McoServer mcoserver = GuiScreenOnlineServers.func_140011_a(this.field_98173_a, GuiScreenOnlineServers.func_140041_a(this.field_98173_a));

            if (mcoserver != null)
            {
                final McoClient mcoclient = new McoClient(GuiScreenOnlineServers.func_98075_b(this.field_98173_a).getSession());

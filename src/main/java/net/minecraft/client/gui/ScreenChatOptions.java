...
public class ScreenChatOptions extends GuiScreen
{
    ...
    private static final EnumOptions[] allScreenChatOptions = {EnumOptions.CHAT_VISIBILITY, EnumOptions.CHAT_COLOR, EnumOptions.CHAT_LINKS, EnumOptions.CHAT_OPACITY, EnumOptions.CHAT_LINKS_PROMPT, EnumOptions.CHAT_SCALE, EnumOptions.CHAT_HEIGHT_FOCUSED, EnumOptions.CHAT_HEIGHT_UNFOCUSED, EnumOptions.CHAT_WIDTH};
    private static final EnumOptions[] allMultiplayerOptions = {EnumOptions.SHOW_CAPE};

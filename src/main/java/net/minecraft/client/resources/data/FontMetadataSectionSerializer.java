...
{
    public FontMetadataSection func_110490_a(final JsonElement par1JsonElement, final Type par2Type, final JsonDeserializationContext par3JsonDeserializationContext)
    {
        final JsonObject jsonobject = par1JsonElement.getAsJsonObject();
        final float[] afloat = new float[256];
        final float[] afloat1 = new float[256];
        ...
        if (jsonobject.has("characters"))
        {
            ...
            final JsonObject jsonobject1 = jsonobject.getAsJsonObject("characters");
            ...
            if (jsonobject1.has("default"))
            {
                ...
                final JsonObject jsonobject2 = jsonobject1.getAsJsonObject("default");
            ...
            for (int i = 0; i < 256; ++i)
            {
                final JsonElement jsonelement1 = jsonobject1.get(Integer.toString(i));
                float f3 = f;
                float f4 = f1;
                float f5 = f2;
                ...
                if (jsonelement1 != null)
                {
                    ...
                    final JsonObject jsonobject3 = jsonelement1.getAsJsonObject();

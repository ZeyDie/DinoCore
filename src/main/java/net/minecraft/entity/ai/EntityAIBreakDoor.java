...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public void updateTask()
    {
        ...
        {
            // CraftBukkit start
            if (org.bukkit.craftbukkit.v1_6_R3.event.CraftEventFactory.callEntityBreakDoorEvent(this.theEntity, this.entityPosX, this.entityPosY, this.entityPosZ).isCancelled())
            {
                this.updateTask();
                return;
            }

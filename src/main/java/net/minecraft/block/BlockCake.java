...
public class BlockCake extends Block
{
    ...
    public void setBlockBoundsBasedOnState(final IBlockAccess par1IBlockAccess, final int par2, final int par3, final int par4)
    {
        ...
        final float f1 = (float)(1 + l * 2) / 16.0F;
        final float f2 = 0.5F;
    ...
    private void eatCakeSlice(final World par1World, final int par2, final int par3, final int par4, final EntityPlayer par5EntityPlayer)
    {
        ...
        {
            // CraftBukkit start
            final int oldFoodLevel = par5EntityPlayer.getFoodStats().foodLevel;
            final org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.v1_6_R3.event.CraftEventFactory.callFoodLevelChangeEvent(par5EntityPlayer, 2 + oldFoodLevel);

...
public class BlockDoor extends Block
{
    ...
    {
        final int l = this.getFullMetadata(par1IBlockAccess, par2, par3, par4);
        return (l & 4) != 0;
    }
    ...
    public boolean onBlockActivated(final World par1World, final int par2, final int par3, final int par4, final EntityPlayer par5EntityPlayer, final int par6, final float par7, final float par8, final float par9)
    {
        ...
        {
            final int i1 = this.getFullMetadata(par1World, par2, par3, par4);
            int j1 = i1 & 7;
            j1 ^= 4;
    ...
    {
        final int l = this.getFullMetadata(par1World, par2, par3, par4);
    ...
    public void onNeighborBlockChange(final World par1World, final int par2, final int par3, final int par4, final int par5)
    {
        ...
        if ((i1 & 8) == 0)
        {
            ...
            else if (par5 > 0 && Block.blocksList[par5].canProvidePower())
            {
                ...
                final org.bukkit.block.Block blockTop = bworld.getBlockAt(par2, par3 + 1, par4);

...
public class BlockDaylightDetector extends BlockContainer
{
    ...
    public void updateLightLevel(World par1World, int par2, int par3, int par4)
    {
        if (!par1World.provider.hasNoSky)
        {
            ...
            if (l != i1)
            {
                i1 = org.bukkit.craftbukkit.v1_6_R3.event.CraftEventFactory.callRedstoneChange(par1World, par2, par3, par4, l, i1).getNewCurrent(); // CraftBukkit - Call BlockRedstoneEvent

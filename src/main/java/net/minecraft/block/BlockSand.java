...
public class BlockSand extends Block
{
    ...
    {
        int par31 = par3;
        if (canFallBelow(par1World, par2, par31 - 1, par4) && par31 >= 0)
        {
            final byte b0 = 32;

            if (!fallInstantly && par1World.checkChunksExist(par2 - b0, par31 - b0, par4 - b0, par2 + b0, par31 + b0, par4 + b0))
            {
                if (!par1World.isRemote)
                {
            ...
            else
            {
                ...
                while (canFallBelow(par1World, par2, par31 - 1, par4) && par31 > 0)
                {
                    --par31;
                }
                ...
                if (par31 > 0)
                {
                    par1World.setBlock(par2, par31, par4, this.blockID);
                }
            }
        }
    }

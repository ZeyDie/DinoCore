...
public class Block {
    ...
    public boolean canSustainPlant(World world, int x, int y, int z, ForgeDirection direction, IPlantable plant) {
        ...
        else if (plantType == EnumPlantType.Nether) return blockID == slowSand.blockID;
        else if (plantType == EnumPlantType.Crop) return blockID == tilledField.blockID;
        else if (plantType == EnumPlantType.Cave) return isBlockSolidOnSide(world, x, y, z, UP);
        else if (plantType == EnumPlantType.Plains) return blockID == grass.blockID || blockID == dirt.blockID;

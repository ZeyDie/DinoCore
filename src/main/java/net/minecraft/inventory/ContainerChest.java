...
public class ContainerChest extends Container
{
    ...
    public CraftInventoryView getBukkitView()
    {
        ...
        {
            inventory = new org.bukkit.craftbukkit.v1_6_R3.inventory.CraftInventoryPlayer((InventoryPlayer) this.lowerChestInventory);
        }
        else if (this.lowerChestInventory instanceof InventoryLargeChest)
        {
            inventory = new org.bukkit.craftbukkit.v1_6_R3.inventory.CraftInventoryDoubleChest((InventoryLargeChest) this.lowerChestInventory);
        }
        else
        {

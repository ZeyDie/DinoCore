...
public abstract class World implements IBlockAccess {
     ...
     * aabb
     */
    public List getCollidingBoundingBoxes(Entity paramEntity, AxisAlignedBB paramAxisAlignedBB) {
        this.collidingBoundingBoxes.clear();
        int i = MathHelper.floor_double(paramAxisAlignedBB.minX);
        int j = MathHelper.floor_double(paramAxisAlignedBB.maxX + 1.0D);
        int k = MathHelper.floor_double(paramAxisAlignedBB.minY);
        int m = MathHelper.floor_double(paramAxisAlignedBB.maxY + 1.0D);
        int n = MathHelper.floor_double(paramAxisAlignedBB.minZ);
        int i1 = MathHelper.floor_double(paramAxisAlignedBB.maxZ + 1.0D);

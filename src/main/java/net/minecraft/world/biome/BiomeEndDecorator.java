...
public class BiomeEndDecorator extends BiomeDecorator
{
    ...
    protected void decorate()
    {
        ...
        {
            final int i = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
            final int j = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
            final int k = this.currentWorld.getTopSolidOrLiquidBlock(i, j);

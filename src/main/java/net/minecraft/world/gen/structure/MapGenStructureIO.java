...
public class MapGenStructureIO
{
    ...
    public static void func_143034_b(final Class par0Class, final String par1Str)
    {
        field_143040_a.put(par1Str, par0Class);
        field_143038_b.put(par0Class, par1Str);
    }

    public static void func_143031_a(final Class par0Class, final String par1Str)
    {
        field_143039_c.put(par1Str, par0Class);
        field_143037_d.put(par0Class, par1Str);
    }

    public static String func_143033_a(final StructureStart par0StructureStart)
    {
        return (String)field_143038_b.get(par0StructureStart.getClass());
    }

    public static String func_143036_a(final StructureComponent par0StructureComponent)
    {
        return (String)field_143037_d.get(par0StructureComponent.getClass());
    }

    public static StructureStart func_143035_a(final NBTTagCompound par0NBTTagCompound, final World par1World)
    {
        StructureStart structurestart = null;

        try
        {
            final Class oclass = (Class)field_143040_a.get(par0NBTTagCompound.getString("id"));
    ...
    public static StructureComponent func_143032_b(final NBTTagCompound par0NBTTagCompound, final World par1World)
    {
        StructureComponent structurecomponent = null;

        try
        {
            final Class oclass = (Class)field_143039_c.get(par0NBTTagCompound.getString("id"));

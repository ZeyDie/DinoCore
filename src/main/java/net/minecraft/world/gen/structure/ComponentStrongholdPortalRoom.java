...
public class ComponentStrongholdPortalRoom extends ComponentStronghold
{
    ...
    {
        final StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(par2, par3, par4, -4, -1, 0, 11, 8, 16, par5);
    ...
    public boolean addComponentParts(final World par1World, final Random par2Random, final StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        if (!this.hasSpawner)
        {
            final int k = this.getYWithOffset(3);
            final int l = this.getXWithOffset(5, 6);
            final int i1 = this.getZWithOffset(5, 6);

            if (par3StructureBoundingBox.isVecInside(l, k, i1))
            {
                this.hasSpawner = true;
                par1World.setBlock(l, k, i1, Block.mobSpawner.blockID, 0, 2);
                final TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)par1World.getBlockTileEntity(l, k, i1);

...
public class GuiModList extends GuiScreen
{
     ...
     * @param mainMenu
     */
    public GuiModList(final GuiScreen mainMenu)
    {
    ...
    {
        final int r = this.fontRenderer.drawString(line, offset, shifty, 0xd7edea);
        return shifty + 10;
    }
     ...
     */
    public void drawScreen(final int p_571_1_, final int p_571_2_, final float p_571_3_)
    {
        ...
        if (selectedMod != null) {
            ...
            if (!selectedMod.getMetadata().autogenerated) {
                int shifty = 35;
                final String logoFile = selectedMod.getMetadata().logoFile;
                if (!logoFile.isEmpty())
                {
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                    final TextureManager tm = mc.getTextureManager();
                    final ResourcePack pack = FMLClientHandler.instance().getResourcePackFor(selectedMod.getModId());
                    try
                    {
                        ...
                        if (logo != null)
                        {
                            final ResourceLocation rl = tm.getDynamicTextureLocation("modlogo", new DynamicTexture(logo));
                ...
                final int rightSide = this.width - offset - 20;
                if (rightSide > 20)
                {
